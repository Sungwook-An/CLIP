...
with open('/root/LGD2024/examples_old/imagenet/imagenet_caption_val.json', 'r') as json_file:
...
csv_file = "/root/LGD2024/examples_old/imagenet/imagenet_caption_val.csv"
try:
