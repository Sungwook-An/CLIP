...
csv_file_path = '/root/LGD2024/examples_old/imagenet/imagenet_caption_train.csv'

image_base_path = '/database/Data/CLS-LOC/train/'
...
df.to_csv('/root/LGD2024/examples_old/imagenet/imagenet_caption_train_with_labels.csv', index=False)
